...
var db_manager = {
	...
	for (var i=0; i<len; i++){
		...
		'<div data-role="collapsible">' +
		    '  <h3>' + ret.rows.item(i).created_at + '</h3>' +
		    '  <p>' + html_encode(ret.rows.item(i).emails) + '</p>' +
		    '  <div class="ui-grid-a">' +
		    '    <div class="ui-block-a"><a href="' + url_www + 'share/email/' + ret.rows.item(i).id + '" data-role="button">浏览</a></div>' +
		    '    <div class="ui-block-b"><a href="#home" data-role="button">删除</a></div>' +
		    '  </div>' +
		    '</div>');		    
	}
